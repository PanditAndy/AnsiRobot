        ...
        query.message.edit_text(text=f"*ʜᴇʏ,*🥀\n  *ᴛʜɪs ɪs {dispatcher.bot.first_name}*"
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            text="Ｏｗｎｅｒ", url=f"https://t.me/Brahman_Anand"
                        ),
                        InlineKeyboardButton(
                         text="Ｃｏ-Ｏｗｎｅｒ", url=f"https://t.me/Its_Anand_Ki_Jaan"   
                        ),
                    ],
                   [
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        ...
                        InlineKeyboardButton(
                            text="♥️ ᴘʟᴀʏ ♥️", callback_data="Music_play"
                        ),
                    ],
                    [
                        InlineKeyboardButton(text="♥️ ʙᴏᴛ ♥️", callback_data="Music_bot"),
                        InlineKeyboardButton(
                            text="♥️  ᴇx͛ᴛʀᴀ ♥️",
...
─╼⃝𖠁----------------𖠁⃝╾─•
му ℓσνє му ℓιƒє = #кιѕнσяι
му ℓσνє му ℓιƒє = #αηαη∂
─╼⃝𖠁-----------------𖠁⃝╾─•
ᴍᴀᴅᴇ ᴡɪᴛʜ ❤  ʙʏ [𝙇𝙀𝙂𝙀𝙉𝘿[🪬]𝘼𝙉𝘼𝙉𝘿]("https://t.me/Brahman_Anand")""",
                parse_mode=ParseMode.MARKDOWN,
            )
        except Unauthorized:
            LOGGER.warning(
