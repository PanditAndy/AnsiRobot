...
import AnsiRobot.modules.sql.userinfo_sql as sql
...
from AnsiRobot import telethn as AnsiTelethonClient
from AnsiRobot.__main__ import STATS, TOKEN, USER_INFO
from AnsiRobot.modules.disable import DisableAbleCommandHandler
from AnsiRobot.modules.helper_funcs.chat_status import sudo_plus
from AnsiRobot.modules.helper_funcs.extraction import extract_user
from AnsiRobot.modules.sql.afk_sql import check_afk_status, is_afk
from AnsiRobot.modules.sql.global_bans_sql import is_user_gbanned
from AnsiRobot.modules.sql.users_sql import get_user_num_chats
...
def info(update: Update, context: CallbackContext):
    ...
    if disaster_level_present:
        text += ' \n[<a href="https://t.me/Ansibotzone/26">ᴄʟɪᴄᴋ ʜᴇʀᴇ ᴛᴏ ᴋɴᴏᴡ ᴡʜᴀᴛ ɪs ᴅɪsᴀsᴛᴇʀ ʟᴇᴠᴇʟs.</a>]'.format(
            bot.username
        )
                    ...
                    [
                        ...
                        [
                            InlineKeyboardButton(
                                ...
                                url=f"https://t.me/ansi_Ro_bot?startgroup=true",
                            ),
                        ],
                    ]
                ),
