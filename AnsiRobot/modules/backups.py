...
# from AnsiRobot.modules.sql import warns_sql as warnssql
import AnsiRobot.modules.sql.blacklist_sql as blacklistsql

# from AnsiRobot.modules.sql import cust_filters_sql as filtersql
# import AnsiRobot.modules.sql.welcome_sql as welcsql
import AnsiRobot.modules.sql.locks_sql as locksql
import AnsiRobot.modules.sql.notes_sql as sql

# from AnsiRobot.modules.rules import get_rules
import AnsiRobot.modules.sql.rules_sql as rulessql
from AnsiRobot import EVENT_LOGS,OWNER_ID, SUPPORT_CHAT, dispatcher
from AnsiRobot.__main__ import DATA_IMPORT
from AnsiRobot.modules.connection import connected
from AnsiRobot.modules.helper_funcs.alternate import typing_action
from AnsiRobot.modules.helper_funcs.chat_status import user_admin
from AnsiRobot.modules.sql import disable_sql as disabledsql
...
def export_data(update, context):
    ...
    with open("AnsiRobot{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("AnsiRobot{}.backup".format(chat_id), "rb"),
        caption="📤*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `AnsiRobot-Backup` was specially made for notes 📚.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("AnsiRobot{}.backup".format(chat_id))  # Cleaning file
