...
@Ansi.on_message(filters.command(["short"]))
...
@Ansi.on_message(filters.command(["unshort"]))
...
# Ansi.add_handler(MessageHandler(short_urls))
# Ansi.add_handler(MessageHandler(unshort))
__help__ = """
 ❍ /short <url>  *:Example /short \n https://t.me/mr_sukkun.
 *"""

__mod_name__ = "♦️ꜱʜᴏʀᴛ♦️"
